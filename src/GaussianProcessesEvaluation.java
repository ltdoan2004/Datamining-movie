...
public class GaussianProcessesEvaluation {
    public static void main(String[] args) throws Exception {
        ...
        Classifier gaussianProcesses = new GaussianProcesses();

        // Measure runtime
        long startTime = System.currentTimeMillis();
        Evaluation evaluation = evaluateModelWithProgress(gaussianProcesses, dataset, 10); // 10-fold CV
        long endTime = System.currentTimeMillis();

        System.out.println("Gaussian Processes:");
